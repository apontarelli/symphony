...
defmodule SymphonyElixir.CoreTest do
  ...
  test "in-repo symphony.yml renders generated prompt correctly" do
    ...
    assert prompt =~ "real auto-land"
    assert prompt =~ "The host validates the evidence, publishes and links the pull request"
    assert prompt =~ "it moves the issue to Merging"
